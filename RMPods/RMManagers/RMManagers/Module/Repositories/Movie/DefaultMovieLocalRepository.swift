...
extension CoreDataMovieDataStorage: LocalMovieRepository {
  public func getAllFavouriteMovie(completion: @escaping ([MoviesFavouritesModel]) -> Void) {
  ...
  public func getSelectedFavourite(
    _ id: Int,
  ...
  public func addFavourite(_ favouriteModel: MoviesFavouritesModel) {
    coreDataStorage.performNewPrivateQueue { context in
      do {
  ...
  public func deleteFavourite(with id: Int) {
    coreDataStorage.performNewPrivateQueue { context in
      do {
