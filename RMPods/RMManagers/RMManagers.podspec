#
# Be sure to run `pod lib lint RMManagers.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'RMManagers'
  s.version          = '0.1.0'
  s.summary          = 'A short description of RMManagers.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/realxnesia/RMManagers'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'realxnesia' => 'dhika.aditya@kpvendor.id' }
  s.source           = { :git => 'https://github.com/realxnesia/RMManagers.git', :tag => s.version.to_s }
